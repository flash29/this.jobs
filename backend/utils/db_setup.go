...
func ConnectDatabase() {
	...
	models.UserPost{}, models.Comment{}, models.JobPost{}, models.JobApplication{}, models.UserToken{})
	models.UserPost{}, models.Comment{}, models.JobPost{}, models.JobApplication{}, models.ConnectionRequest{}, models.UserToken{})
	...
	database.Model(&models.JobApplication{}).AddForeignKey("job_id", "job_posts(id)", "CASCADE", "CASCADE")
